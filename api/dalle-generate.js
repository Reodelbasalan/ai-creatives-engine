      ...
      try {
        ...
        if (refBuf) {
          ...
          const editPrompt = [
            ...
            "Preserve the person's exact face shape and width, full cheeks, natural hair volume and hairline, and true facial proportions. Do not slim, refine, or idealize the face — keep it exactly as the reference, imperfections included.",
